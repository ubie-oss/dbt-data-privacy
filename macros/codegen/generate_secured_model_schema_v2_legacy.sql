{% macro generate_secured_model_schema_v2_legacy(
      objective,
      name,
      database,
      schema,
  ...
  {{- return(adapter.dispatch('generate_secured_model_schema_v2_legacy', 'dbt_data_privacy')(
      objective=objective,
      name=name,
      database=database,
      schema=schema,
...
{% macro default__generate_secured_model_schema_v2_legacy(
      objective,
      name,
      database,
      schema,

{% macro test_flatten_restructured_columns_for_schema_legacy() %}
  {{ return(adapter.dispatch("test_flatten_restructured_columns_for_schema_legacy", "dbt_data_privacy_integration_tests")()) }}
{% endmacro %}

{% macro bigquery__test_flatten_restructured_columns_for_schema_legacy() %}
